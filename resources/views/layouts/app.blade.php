            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    <ul class="navbar-nav mr-3">
                        <li><a href="#" data-id="faBars" data-toggle="sidebar" class="nav-link nav-link-lg"><i
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-id="dropDownUser" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="{{ route('logout') }}" data-id="btnLogout"
